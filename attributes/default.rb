...
node.override['delivery_build']['packages']['chefdk'] = 'chefdk-0.14.25-1.el7.x86_64.rpm'
node.override['delivery_build']['packages']['delivery-cli'] ='delivery-cli-0.0.15-1.el6.x86_64.rpm'
